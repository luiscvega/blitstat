...
describe User do
  ...
  describe "credentials" do
    ...
    it "email should not be blank" do    
      blank_email = User.new(@attr.merge(:email => ""))
      blank_email.should_not be_valid
    end

    it "password should not be blank" do
      blank_password = User.new(@attr.merge(:password => ""))
      blank_password.should_not be_valid
    end
    
    it "should have the right username length" do
      long_username = "a"*40
      invalid_username = User.new(@attr.merge(:username => long_username))
   ...
   it "should set the encrypted password attribute" do
    ...
    describe "has_password? method" do
      ...
      it "should return true if the passwords match" do
        @user.has_password?("asdf").should be_true
      end
